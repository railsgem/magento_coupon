 ...
 */
class MageWorkshop_DetailedReview_Block_Review_Newform extends MageWorkshop_DetailedReview_Block_Review_Form
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('detailedreview/newform.phtml')
            ->assign('data', $data)
    ...
    public function getAction()
    {
        ...
        $itemId = Mage::app()->getRequest()->getParam('item_id', false);
        return Mage::getUrl('review/product/post', array('id' => $productId, 'item_id' => $itemId, '_secure' => $this->_isSecure()));
    }
